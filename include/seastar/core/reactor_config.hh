...
struct reactor_options : public program_options::option_group {
    ...
    program_options::value<memory::alloc_failure_kind, program_options::enum_mapping_policy<memory::alloc_failure_kind>> dump_memory_diagnostics_on_alloc_failure_kind;
