...
void smp::configure(boost::program_options::variables_map configuration, const reactor_options& reactor_opts, reactor_config reactor_cfg)
{
    ...
    for (i = 1; i < smp::count; i++) {
        ...
        create_thread([this, smp_tmain, inited, &reactors_registered, &smp_queues_constructed, configuration, &reactor_opts, &reactors, hugepages_path, i, allocation, assign_io_queues, alloc_io_queues, thread_affinity, heapprof_enabled, mbind, backend_selector, reactor_cfg] {
          try {
