...
net::dpdk_options::dpdk_options(program_options::option_group* parent_group)
...
net::dpdk_options::dpdk_options(program_options::option_group* parent_group, program_options::unused u)
    : program_options::option_group(parent_group, "DPDK net options", u)
    , dpdk_port_index(*this, "dpdk-port-index", u)
    , hw_fc(*this, "hw-fc", u)
{
}
